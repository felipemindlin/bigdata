...
---------+----------+------------+----------+----------+--------------+-----------
 org_001 |  compute | 2026-06-15 |      8.4 |      120 |            0 |       1.6
 org_001 |    genai | 2026-06-15 |      4.1 |       25 |         5000 |       0.3
 org_003 | database | 2026-06-15 |      1.8 |      200 |            0 |         0
...
---------+------------+----------+--------------
 org_003 | 2026-06-15 | database |          1.8
 org_001 | 2026-06-15 |  compute |          8.4
 org_001 | 2026-06-15 |    genai |          4.1
...
### Query 1: costos y requests diarios de `org_001` / `compute` (junio 2026)
...
WHERE org_id = 'org_001'
  AND service = 'compute'
  AND usage_date >= '2026-06-01'
  AND usage_date <= '2026-06-30';
```
